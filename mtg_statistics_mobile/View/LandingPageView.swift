            ...
            Form {
                ...
                ForEach(0..<4, id: \.self) { index in
                    Picker("Player \(index + 1)", selection: $selectedIndices[index]) {
                        ...
                        ForEach(viewModel.availablePlayers.indices, id: \.self) { i in
                            Text(viewModel.availablePlayers[i]).tag(i)
                        }
                    }
                ...
                Button("Start Game") {
                    ...
                    if selectedIndices.contains(-1) {
                        ...
                        selectedPlayers = selectedIndices.map { viewModel.availablePlayers[$0] }
                        // Trigger navigation.
